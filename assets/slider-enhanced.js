...
class CarouselSlider extends HTMLElement {
  ...
  initSlider() {
    ...
    const sliderItemsPerNav = (window.theme && window.theme.settings && window.theme.settings.sliderItemsPerNav) || 'item';
    this.slidesToScroll = sliderItemsPerNav === 'page' ? this.slidesPerPage : 1;
